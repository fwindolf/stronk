...
class ExerciseValidationItems {
  ...
  final ValidationItem<ExerciseConfiguration> type;
  ...
  ExerciseValidationItems({
    ...
    this.type = const ValidationItem<ExerciseConfiguration>(null, null),
...
class Validator {
  ...
  final typeValidator = AlwaysValidValidator<ExerciseConfiguration>();
...
class ExerciseValidationNotifier extends StateNotifier<ExerciseValidationItems> with Validator {
  ExerciseValidationNotifier({
    ...
    List<Instruction>? instructions,
          ...
          ExerciseValidationItems(
            ...
            type: ValidationItem<ExerciseConfiguration>(type, null),
  ...
  void updateType(ExerciseConfiguration? value) {
    if (typeValidator.isValid(value)) {
      state = state.copyWith(type: ValidationItem<ExerciseConfiguration>(value, null));
    } else {
      final error = typeValidator.errorText(value);
      state = state.copyWith(type: ValidationItem<ExerciseConfiguration>(null, error));
    }
  }
